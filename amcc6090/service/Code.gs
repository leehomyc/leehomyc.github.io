...
function speakerSheet() {
  ...
  if (sheet.getLastRow() === 0) sheet.appendRow(['Created at','Session','Speaker name','Materials URL','Materials note','Updated at']);
  return sheet;
}
...
function validSpeakerSession(value) { return /^(0[2-9]|1[0-3])$/.test(value); }
